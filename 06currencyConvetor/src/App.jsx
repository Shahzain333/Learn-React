        ...
        <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
          ...
          <form onSubmit={(e) => { e.preventDefault(); convert(); }} >
            ...
            <div className="w-full mb-1">
              ...
              <InputBox label="From" amount={amount} onAmountChange={(amount) => setAmount(amount)} onCurrencyChange=
              {(currency) => { setFrom(currency); }} currencyOptions={options} selectCurrency={from}/>
            ...
            <div className="w-full mt-1 mb-4">
              ...
              <InputBox label="To" amount={convertedAmount} currencyOptions={options} onCurrencyChange=
              {(currency) => { setTo(currency); }} selectCurrency={to}
                //   amountDisable
              />
            </div>
